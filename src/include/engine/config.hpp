...
namespace engine {
    struct config {
         ...
         */
        std::string ssl_session_listener_private_key_ = "session_listener.key";

        /**
         * SSL Session Chain Certificate
         */
        std::string ssl_session_chain_certificate_ = "session.crt";
         ...
         */
        std::string ssl_client_listener_chain_certificate_ = "client_listener.crt";

        /**
         * SSL Client Listener Private Key
         */
        std::string ssl_client_listener_private_key_ = "client_listener.key";

        /**
         * SSL Client Chain Certificate
         */
        std::string ssl_client_chain_certificate_ = "client.crt";
